...
switch (key) {
    ...
    {name: 'الادارة', icon: 'fa-edit', extension: [
      ...
      default:
        ...
        {name: 'تمدرس التلاميذ', icon: 'fa-users', extension: [
         {name: 'تحديد عدد سنوات التمدرس', icon: '' ,  path: ''},
         {name: 'تصدير و استيراد سنوات التمدرس', icon: '' ,  path: ''},
         {name: 'احصاء التمدرس', icon: '' ,  path: ''},
         {name: 'تصحيح البيانات', icon: '' ,  path: ''},
         {name: 'مصادقة على بيانات', icon: '' ,  path: ''}
        ]},
        {name: 'التبادل مع الشركاء', icon: '', extension: [
         {name: 'شركاء المؤسسة', icon: '' ,  path: ''},
         {name: 'المصادقة الاولية على تمدرس التلاميذ', icon: '' ,  path: ''}
        ]},
        {name: 'خدمات مسار', icon: 'fa-user', extension: [
         {name: 'القن السري للولي', icon: '' ,  path: ''},
         {name: 'المصادقة على بيانات الولي', icon: '' ,  path: ''},
         {name: 'المصادقة على طلبات المواعيد', icon: '' ,  path: ''}
        ]},
        {name: 'الادارة', icon: '', extension: [
         {name: 'لائحة المستخدمين', icon: '' ,  path: ''},
         {name: 'تصدير و استيراد البيانات', icon: '' ,  path: ''}
        ]}
       ];
        break;
      }
...
getNbsansNationalite() {
  ...
  getCountries(): Array<string> {
    return ['فرنسا','الجزائر','إيطاليا','أفغانستان','جنوب أفريقيا','ألبانيا','ألمانيا','أندورا',
    'أنغولا','أنغويلا','أنتاركتيكا','أنتيغوا وبربودا','المملكة العربية السعودية','الأرجنتين','أرمينيا',
    'أروبه','أستراليا','النمسا','أذربيجان','الباهاماس','البحرين','بنغلاديش','روسيا البيضاء','بلجيكا',
    'بيليز','بنين','جزر برمودا','بوتان','بوليفيا','البوسنة و الهرسك','بوتسوانا','البرازيل','بروني',
    'بلغاريا','بوركينا فاسو','بوروندي','كمبوديا','كاميرون','كندا','شيلي','جمهورية الصين الشعبية',
    'قبرص','الفاتيكان','كولومبيا','جزر القمر','جمهورية الكونغو','كوريا الجنوبية','كوريا الشمالية',
    'كوستاريكا','ساحل العاج','كرواتيا','كوبا','الدانمارك','جيبوتي','دومينيكا','مصر','إلسلفادور',
    'الإمارات العرب','إكوادور','إسبانيا','استونيا','الولايات المتحدة','أثيوبيا','فيجي','فنلندا',
    'الغابون','غامبيا','جيورجيا','غانا','جبل طارق','اليونان','غرينادا','جرينلاند','جزر جوادلوب',
    'جوام','غواتيمال','غينيا','غينيا - بيساو','غيانا','غويانا الفرنسية','المجر','ريونيون',
    'جزر كوك','جزر فارو','جزر ماريانا الشمالية','جزر مارشال','جزر سليمان','الجزر العذراء البريطانية',
    'الجزر العذراء الأمريكي','الهند','أندونيسيا','العراق','إيران','إيرلندا','آيسلندا','إسرائيل',
    'جمايكا','اليابان','الأردن','كازاخستان','كينيا','قيرغيزستان','كيريباتي','الكويت','بربادوس',
    'غينيا الاستوائي','سلوفاكيا','سلوفينيا','لاوس','الرأس الأخضر','ليختنشتين','تركمانستان','إريتريا',
    'ساموا - الأمريكي','ليسوتو','لاتفيا','لبنان','ليبيريا','ليبيا','لتوانيا','أوزباكستان','لوكسمبورغ',
    'ماكاو','مقدونيا','مدغشقر','ماليزيا','مالاوي','المالديف','مالي','مالطا','مارتينيك','المكسيك',
    'مايكرونيزيا','الجبل الأسود','النيجر','النرويج','كاليدونيا الجديدة','عمان','أوغندا','باكستان',
    'بالاو','فلسطين','بنما','بابوا غينيا الجديدة','باراغواي','جزر الأنتيل الهولندي','بيرو','الفليبين',
    'بولونيا','بولينيزيا الفرنسية','بورتو ريكو','البرتغال','قطر','جمهورية أفريقيا الوسطى','جمهورية الكونغو',
    'الجمهورية الدومينيكية','الجمهورية التشيكية','رومانيا','المملكة المتحدة','روسيا','رواندا',
    'سانت لوسيا','سانت كيتس ونيفس','سان مارينو','سان فانسون','المناطق','ساو تومي وبرينسيبي','السنغال',
    'جمهورية صربيا','سيشيل','سيراليون','سنغافورة','الصومال','السودان','سريلانكا','السويد','سويسرا',
    'سورينام','سوازيلند','سوريا','طاجيكستان','تايوان','تنزانيا','تشاد','تايلندا','تبت',
    'تيمور الشرقية','توغو','تونغا','ترينيداد وتوباغو','تونس','تركيا','توفالو','أوكرانيا','أورغواي',
    'فانواتو','فنزويلا','فيتنام','اليمن','المغرب','موريتانيا','نيجيريا'];
  }
